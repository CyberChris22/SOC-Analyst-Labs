...
Each lab folder contains a README with objectives, steps, outcomes, and supporting files. Screenshots and artifacts are stored in `/Assets/` and `/Artifacts/`.

## Contact

[LinkedIn: cyberchris22](https://www.linkedin.com/in/cyberchris22)

*Feel free to reach out to discuss my projects or cybersecurity opportunities!*

*Built as a portfolio for SOC analyst roles, Fall 2025.*
