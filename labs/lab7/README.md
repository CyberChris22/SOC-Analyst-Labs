...
- Screenshot: ![Agent Status](Assets/lab7-00_agent_status_windows.png)  
...
- Added filters in Discover for:
  ...
  - `data.win.system.eventID` → 4720, 4728  
  - Optional: `rule.level` → moderate+  
- Saved the filtered view as **Lab7_Filters**  
- Screenshot: ![Discover Filters](Assets/lab7-01_Discover_Filters.png)  
...
- Screenshot: ![Threat Hunting Filtered View](Assets/lab7-02_WazuhDashboard_FilteredView.png)  
...
- Screenshot: ![Filtered CSV Export](Assets/lab7-03_Discover_FilteredExport.csv)  
...
- Screenshot: ![Custom Dashboard Widgets](Assets/lab7-04_CustomDashboard_Widgets.png)  
- Notes: Widgets created successfully even with no events

### 6. Dashboard Overview

- Opened **Lab7_CustomDashboard** to display all 3 widgets together  
- Screenshot: ![Dashboard Report](Assets/lab7-05_CustomDashboard_Report.pdf)  
