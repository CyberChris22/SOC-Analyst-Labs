...
Generate simulated security events, detect suspicious activity using Sysmon and Wazuh, practice containment and evidence collection, understand event correlation and monitoring limitations, and document incident response actions.

## Environment

- Windows 10 VM (target system)  
- Wazuh agent running as `wazuhsvc`  
- Ubuntu server running Wazuh manager  
- Event Viewer for Sysmon, Security, System, and Application logs
...
- Screenshot: ![Agent Status](Assets/lab6-00_agent_status_windows.png)  
...
- Screenshots:  
  ![User Account Created](Assets/lab6-01_UserAccountCreated_4720.png)  
  ![Admin Group Change](Assets/lab6-02_AdminGroupChange_4728.png)  
  ![Wazuh Alert Admin Group](Assets/lab6-03_WazuhAlert_AdminGroupChange.png)  
...
- Screenshots:  
  ![Sysmon Powershell Encoded](Assets/lab6-04_Sysmon_Powershell_encoded.png)  
  ![Sysmon Powershell Encoded](Assets/lab6-06_Sysmon_Powershell_Encoded.png)  
...
- Screenshots:  
  ![FileCreate Sysmon](Assets/lab6-07_FileCreate_sysmon.png)  
  ![LabIR Marker](Assets/lab6-08_LabIR_Marker_Event.png)  
...
- Screenshot: ![Simulated DNS Timeout](Assets/lab6-05_Simulated_DNS_Timeout_600.png)  
...
- Screenshots:  
  ![Task Manager](Assets/lab6-09_Containment_TaskManager.png)  
  ![Process List Evidence](Assets/lab6-09_ProcessList_Evidence.png)  
- Evidence file created: `C:\process_list.txt`  
- Notes: Safely terminated process, exported evidence.

#### 6.B Network Containment

- Disabled VM network adapter to simulate isolation:  
  `Disable-NetAdapter -Name "Ethernet" -Confirm:$false`  
- Screenshot: ![Network Disabled](Assets/lab6-10_Containment_NetworkDisabled.png)  
...
- Screenshot: ![Wazuh Service Restored](Assets/lab6-12_Wazuh_Service_Restored.png)

### 7. Evidence Collection Commands

- Sysmon events:  
  ```powershell
  wevtutil qe Microsoft-Windows-Sysmon/Operational /f:text /c:50 > C:\Lab6_Sysmon_Events.txt
  ```  
- Security events:  
  ```powershell
  wevtutil qe Security /f:text /c:50 > C:\Lab6_Security_Events.txt
  ```  
